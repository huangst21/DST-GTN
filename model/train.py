...
from model.DSTGTN import DSTGTN
...
if __name__ == "__main__":
    ...
    parser.add_argument("-seed", "--seed", type=int, default=72)
    ...
    model_name = DSTGTN.__name__

    with open(f"{model_name}.yaml", "r") as f:
        cfg = yaml.safe_load(f)
    cfg = cfg[dataset]
    # -------------------------------- load model -------------------------------- #
#     st = args.st_embedding_dim
    model = DSTGTN(**cfg["model_args"])
